...
module "vpc" {
  ...
  multi_az_nat         = local.env_config.multi_az_nat
}
...
module "security_groups" {
  ...
  bastion_ssh_cidr = local.env_config.bastion_ssh_cidr
}
...
module "eks" {
  ...
  nodegroup_instance_types = local.env_config.eks_nodegroup_instance_types
  eks_node_scaling_min_size = local.env_config.eks_node_scaling.min_size
  eks_node_scaling_max_size = local.env_config.eks_node_scaling.max_size
  eks_node_scaling_desired_size = local.env_config.eks_node_scaling.desired_size
...
module "ec2" {
  ...
  bastion_instance_type = local.env_config.bastion_instance_type
  jenkins_ami         = var.jenkins_ami
  jenkins_instance_type = local.env_config.jenkins_instance_type
